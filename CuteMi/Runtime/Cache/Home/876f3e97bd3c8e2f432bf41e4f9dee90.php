...
<div class="site-info">
    <div class="container">
        <div class="info-text">
                        ...
                        <?php if(is_array($flink)): foreach($flink as $key=>$flink): ?><a href="http://<?php echo ($flink['href']); ?>" ><?php echo ($flink["name"]); ?></a>
                            <span class="sep">|</span><?php endforeach; endif; ?>  
                        </p>
...
<iframe id="unjcIfrm" src="/CuteMi/Public/home/images/官网未登录.html" style="width: 0px; height: 0px;"></iframe></body></html>