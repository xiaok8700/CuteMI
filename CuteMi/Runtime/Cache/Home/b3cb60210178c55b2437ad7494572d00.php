...
<title>小米帐号 - 注册</title>
	...
	<link type="text/css" rel="stylesheet" href="/Cutemi/Public/home/css/registerpwd.css">
...
<div class="layout">
  ...
  <div><div class="regbox">
    <form action="/Cutemi/index.php/Home/Login/doregister" method="post">
    <div class="inputbg">
      <label class="labelbox" for="">
        <input type="text" name="uname" data-type="PH" placeholder="请输入用户名">
      </label>
    </div>
    <div class="inputbg">
      <label class="labelbox" for="">
	   <input name="upwd" data-type="PH" placeholder="请输入密码" type="password">
        <!-- <input type="tel" name="upwd" data-type="PH" placeholder="请输入密码"> -->
      </label>
    </div>
    <div class="inputbg">
      <label class="labelbox" for="">
	  <input name="repwd" data-type="PH" placeholder="确认密码" type="password">
        <!-- <input type="tel" name="repwd" data-type="PH" placeholder="确认密码"> -->
      </label>
    </div>
    <div class="err_tip">
    ...
    <div class="inputbg inputcode dis_box">
      ...
      <img alt="图片验证码" title="看不清换一张" class="icode_image code-image chkcode_img" src="/Cutemi/index.php/Home/Login/getCode" onclick=this.src='/Cutemi/index.php/Home/Login/getCode?d='+Math.random();>
    </div>
    <div class="err_tip">
      <div class="dis_box"><em class="icon_error"></em><span></span></div>
    </div>
    ...
    <input class="btn332 btn_reg_1 submit-step" data-to="phone-step2" type="submit" value="立即注册">
      ...
      <img style="display:none;" src="./tick">
      <p class="msg">
      <a href="/Cutemi/index.php/Home/Login/index" target="_blank" title="用户协议">已有账号,点击登录</a>
      </p>
    </div>
  </div>
</div></div></div>
...
<div class="n-footer">
  ...
  <p class="nf-intro"><span>小米公司版权所有-京ICP备10046444-<a class="beianlink beian-record-link" target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802020134"><span><img src="/Cutemi/Public/home/images/ghs.png"></span>京公网安备11010802020134号</a>-京ICP证110507号</span></p>
</div>
